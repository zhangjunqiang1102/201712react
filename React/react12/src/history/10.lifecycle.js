...
class Counter extends React.Component {//React.PureComponent 它会比较两个状态相等就不会刷新视图 浅比较
    static defaultProps = {
        name: 'zzz'
    };
    ...
    render() {
        ...
        return (
            <div>
                ...
                {this.state.number>3?null:<ChildCounter n={this.state.name}/>}
